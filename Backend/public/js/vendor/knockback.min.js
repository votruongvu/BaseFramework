    ...
    return function (factory) {
        ...
        ORMAdapter_Supermodel = function () {
            ...
            ORMAdapter_Supermodel.prototype.bind = function (model, key, update, path) {
                ...
                rel_fn = function (model, other) {
                    ...
                    !kb.statistics || kb.statistics.addModelEvent({name: "update (supermodel)", model: model, key: key, path: path});
        ...
        kb.Store = function () {
            ...
            Store.prototype.findOrCreate = function (obj, options) {
                var creator, observable, _this = this;
                options.store = this;
        ...
        kb.EventWatcher = function () {
            ...
            EventWatcher.prototype.registerCallbacks = function (obj, callback_info) {
                var callbacks, event_name, event_names, event_selector, info, list, _j, _len1, _this = this;
                ...
                for (_j = 0, _len1 = event_names.length; _j < _len1; _j++) {
                    ...
                    if (!callbacks) {
                        list = [];
                        callbacks = {list: list, fn: function (model) {
                            var info, _k, _len2;
        ...
        kb.Observable = function () {
            function Observable(model, options, _vm) {
                ...
                return kb.ignore(function () {
                    ...
                    observable = kb.utils.wrappedObservable(_this, ko.dependentObservable({read: function () {
                    ...
                    observable.model = _this.model = ko.dependentObservable({read: function () {
                    ...
                    kb.EventWatcher.useOptionsOrCreate({event_watcher: event_watcher}, model, _this, {emitter: _this.model, update: _.bind(_this.update, _this), key: _this.key, path: create_options.path});
        ...
        kb.ViewModel = function () {
            ...
            function ViewModel(model, options, view_model) {
                ...
                return kb.ignore(function () {
                    ...
                    _this.model = ko.dependentObservable({read: function () {
                        _mdl();
            ...
            ViewModel.prototype.createObservables = function (model, keys, is_static) {
                ...
                if (is_static) {
                    ...
                    create_options = {store: kb.utils.wrappedStore(this), factory: kb.utils.wrappedFactory(this), path: this.__kb.path, event_watcher: kb.utils.wrappedEventWatcher(this)}
                }
        ...
        kb.CollectionObservable = function () {
            ...
            function CollectionObservable(collection, options) {
                ...
                return kb.ignore(function () {
                    ...
                    observable.collection = _this.collection = ko.dependentObservable({read: function () {
        ...
        ko.bindingHandlers["inject"] = {init: function (element, value_accessor, all_bindings_accessor, view_model) {
        ...
        kb.DefaultObservable = function () {
            function DefaultObservable(target_observable, dv) {
                var observable, _this = this;
                this.dv = dv;
                observable = kb.utils.wrappedObservable(this, ko.dependentObservable({read: function () {
                    var current_target;
        ...
        kb.valid = {required: function (value) {
            return!value
        }, url: function (value) {
